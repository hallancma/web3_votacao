...
contract Web3Votacao {
    address owner;
    uint public currentVoting = 0;  // Votação atual
    Voting[] public votings; // array da votação
    ...
    function addVote(uint choice) public {
        ...
        require(votes[currentVoting][msg.sender].date == 0, "You alredy voted on this voting");
